            ...
            <div>
                ...
                <div className="shopping-cart-container">
                    ...
                    <div className="prices-div">
                        <div className="price-container"> <p> Subtotal </p> <p> Rs {this.state.PriceWithoutDiscountState} </p> </div>
                        <div className="price-container"> <p> Discount </p> <p> Rs {this.state.DiscountState} </p> </div>
                        <div className="price-container"> <p> Total </p> <p> Rs {this.state.TotalState} </p> </div>
